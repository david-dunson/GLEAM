...
nonnullcases=read.csv(file=paste(read_dir,'simu_nonnull_binary_cov_',idnum,'.csv',sep=""),head=F,sep=",")
#[Y_binary_nocov,S,E]
...
outputPath=file.path("/data/zhub/Admixture/output_nonnull_binary_cov",outputName)
